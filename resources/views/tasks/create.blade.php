                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="float-end" style="margin-bottom: 20px;">
                                        <a href="{{ route('tasks.index') }}"  style="background-color: rgb(4, 4, 66); color: white; border:1px solid blue; border-radius: 5px; padding: 10px;">&larr; Retour</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <form action="{{ route('tasks.store') }}" method="post">
                                        ...
                                        <div class="mb-3 row">
                                            <input type="submit" style="background-color: green; color: white; border:1px solid green; border-radius: 5px; padding: 10px;float: right;"  value="Ajouter Tâche">
                                        </div>
